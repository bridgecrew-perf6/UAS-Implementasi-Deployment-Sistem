...
<meta name="keywords" content="Halaman Login Web PKM" />
  ...
  />
	<!-- Custom Theme files -->
	<link href="{{ asset('asset/Login_v18/style.css') }}" rel="stylesheet" type="text/css" media="all" />
	<link href="{{ asset('asset/Login_v18/font-awesome.min.css') }}" rel="stylesheet" type="text/css" media="all" />
	<!-- //Custom Theme files -->
...
<div class="w3layouts-main"> 
	<div class="bg-layer">
        <h1 class="animate_animated animate_bounceInDown" style=" animation-duration: 3s;" ><font color="white"><strong>Admin</strong></font></h1>
		<div class="header-main animate_animated animate_fadeInDown" style=" animation-duration: 3s;" >
			<!-- <div class="main-icon">
		...
		<div class="copyright animate_animated animate_fadeInUp" style=" animation-duration: 3s;">
			<p>© 2022 Regita rahma . All rights reserved</p>
		</div>
		<!-- //copyright --> 
	</div>
</div>	
