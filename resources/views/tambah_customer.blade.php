...
$(document).ready(function(){
  ...
  $("#provinsidd").change(function(){
    ...
    $.ajax({
      ...
      success:function(data){
        $('#kotadd').html('');
        $('#kotadd').append('<option value="">Pilih Provinsi</option>');
  ...
  $("#kotadd").change(function(){
    ...
    $.ajax({
      ...
      success:function(data){
        $('#kecamatandd').html('');
        $('#kecamatandd').append('<option value="">Pilih Kota</option>');
        for(var i=0;i<data.length;i++){
  ...
  $("#kecamatandd").change(function(){
    ...
    $.ajax({
      ...
      success:function(data){
        $('#kelurahandd').html('');
        $('#kelurahandd').append('<option value="">Pilih Kelurahan</option>');
        for(var i=0;i<data.length;i++){
